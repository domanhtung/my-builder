        ...
        {serveContents?.map((content, index) => {
          return (
            <SwiperSlide key={index} className="pb-10">
              <div className="serve py-10 2xl:py-20">
                <div className="container grid lg:grid-cols-2 gap-5 lg:gap-0 mx-auto px-5">
                  <div className="lg:pr-20">
                    <div className="text-[18px] 2xl:text-[22px] text-[#7C90F9] font-semibold">
                      We serve
                    </div>
                    <div className="py-2 2xl:py-3 text-light text-[30px] 2xl:text-[36px] font-bold">
                      {content?.title}
                    </div>
                    <div className="text-light text-[16px] 2xl:text-[18px]">
                      {content?.content}
                    </div>
