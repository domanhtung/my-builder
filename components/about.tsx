...
const AboutUs = () => {
  return (
    <div className="container grid grid-cols-2 mx-auto py-[120px] px-5 gap-20 items-center">
      ...
      <div>
        <div className="text-[22px] font-semibold text-[#233FD6]">About Us</div>
        <div className="mt-2 text-[50px] font-bold">
        ...
        <div className="grid grid-cols-2 mt-20">
          <div />
          <div>
            <div className="text-[30px] font-semibold">Jodie Phan</div>
            <div className="text-[18px]">CEO & co-founder of Archibuild</div>
          </div>
        </div>
      </div>
    </div>
